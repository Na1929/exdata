...
```{r}
alldata<-read.table("Ex1alldata.txt",
                 header=FALSE)
...
print(g)
ggsave(file = "Fig1.png", plot = g, dpi = 300)
```
...
print(g)
ggsave(file = "Fig2.png", plot = g, dpi = 300)
```
...
g <- g + labs(x="Temporal Adv", y="RT (ms)")
print(g)
ggsave(file = "Fig3.png", plot = g, dpi = 300)
```
...
g <- g + labs(x="Temporal Adv", y="RT (ms)")
print(g)
ggsave(file = "Fig4.png", plot = g, dpi = 300)
```
...
g <- g + labs(x="Temporal Adv", y="RT (ms)")
print(g)
ggsave(file = "Fig5.png", plot = g, dpi = 300)
```
